              ...
              <div className="contact-inner-wrapper d-flex justify-content-between">
                <div>
                  ...
                  <form action="" className='d-flex flex-column gap-15'> 
                    <div>
                      <input type="text" className='form-control' name="" placeholder='name' id="" />
                    </div>

                    <div>
                      <input type="email" className='form-control' name="" placeholder='email' id="" />
                    </div>

                    <div>
                      <input type="tel" className='form-control' name="" placeholder='Mobile Number' id="" />
                    </div>
