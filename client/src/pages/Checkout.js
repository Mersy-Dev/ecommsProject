          ...
          <div className="row">
            <div className="col-7">
              <div className="checkout-left-data">
                <h3 className='website-name'>Mercy Code</h3>
                <nav style={{ "--bs-breadcrumb-divider": ">" }} aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    <i className="breadcrumb-item">
            ...
            <div className="col-5">
              <div className=" border-bottom py-4">
                <div className="d-flex gap-10 mb-2 align-items-center">
                  <div className='w-75 d-flex gap-10'>
                    ...
                    <div>
                      <h5 className="total-price">wfgdseljd</h5>
                      <p className='total-price'>s / #dfghgf</p>
                    </div>
                  </div>
                  <div className=' flex-grow-1'>
                    <h5 className='total'>
              ...
              <div className=' border-bottom py-4'>
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <p className='total-price'>$ 9615</p>
                </div>
                <div className="d-flex justify-content-between align-items-center">
                  <p className='mb-0 total'>Shipping</p>
                  <p className='mb-0 total-price'>$ 385</p>
                </div>
              </div>
